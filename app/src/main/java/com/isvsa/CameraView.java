			...
			try {
				...
				mCamera.setPreviewCallback(new PreviewCallback() {
					...
					public void onPreviewFrame(byte[] data, Camera camera) {
						...
						int []color ={bitmap.getPixel((mWidth / 2)-80, (mHeight / 2)+80),//1
								bitmap.getPixel((mWidth / 2)-80, (mHeight / 2)),//2
								bitmap.getPixel((mWidth / 2)-80, (mHeight / 2)-80),//3
								bitmap.getPixel((mWidth / 2), (mHeight / 2)+80),//4
								bitmap.getPixel((mWidth / 2), (mHeight / 2)),//5
								bitmap.getPixel((mWidth / 2), (mHeight / 2)-80),//6
								bitmap.getPixel((mWidth / 2)+80, (mHeight / 2)+80),//7
								bitmap.getPixel((mWidth / 2)+80, (mHeight / 2)),//8
								bitmap.getPixel((mWidth / 2)+80, (mHeight / 2)-80)//9
						};
						//Log.w("Activity", "R:" + mWidth + " G:" + mHeight );
						for(int i=0;i<9;i++){
							if (ColorUtil.compareSpan(colorOld[i], color[i]) > 10) {
								if (colorChange != null) {
